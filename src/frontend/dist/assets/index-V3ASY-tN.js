...
const Gem = createLucideIcon("gem", __iconNode$e);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-2xl font-semibold gradient-gold mb-3", children: "Beauty N Joy" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground font-body leading-relaxed mb-5", children: "Your trusted destination for luxury beauty experiences. We blend artistry with care to bring out your most radiant self." }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-base font-semibold text-foreground mb-4", children: "Quick Links" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-base font-semibold text-foreground mb-4", children: "Our Services" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: SERVICE_LINKS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display text-base font-semibold text-foreground mb-4", children: "Stay Connected" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3 mb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2 text-sm text-muted-foreground font-body", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "w-4 h-4 mt-0.5 flex-shrink-0 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "123 Rose Avenue, Beauty Street, Mumbai 400001" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-sm text-muted-foreground font-body", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-4 h-4 flex-shrink-0 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "+91 6388989935" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-center gap-2 text-sm text-muted-foreground font-body", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-4 h-4 flex-shrink-0 text-accent" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "hello@beautynjoy.in" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body mb-2", children: "Get beauty tips in your inbox" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 py-5 flex flex-col sm:flex-row items-center justify-between gap-2 text-xs text-muted-foreground font-body", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
            "© ",
            year,
            " Beauty N Joy. All rights reserved."
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center justify-center mb-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute w-20 h-20 rounded-full border-2 border-primary/20 animate-ping" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute w-14 h-14 rounded-full border border-accent/40 animate-pulse" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-3xl font-display font-semibold gradient-gold", children: "B" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-xl tracking-widest gradient-gold", children: "Beauty N Joy" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-xs font-body text-muted-foreground tracking-widest uppercase", children: "Preparing your experience…" })
      ]
    }
  );
}
...
function Navbar() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-40 transition-smooth ${scrolled ? "bg-card/95 backdrop-blur-md border-b border-border shadow-card" : "bg-transparent"}`,
      "data-ocid": "navbar.section",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16 md:h-20", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
            ...
            "nav",
            {
              ...
              children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  ...
                  className: `px-3 py-1.5 text-sm font-body transition-smooth rounded-md ${activeSection === link.href.replace("#", "") ? "text-accent font-medium" : "text-foreground/70 hover:text-foreground"}`,
        ...
        menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-card/98 backdrop-blur-md border-t border-border shadow-elegant", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "nav",
          {
            ...
            children: [
              NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "a",
                {
                  href: link.href,
                  onClick: (e) => handleNavClick(e, link.href),
                  className: `px-4 py-3 text-sm font-body rounded-lg transition-smooth ${activeSection === link.href.replace("#", "") ? "text-accent font-medium bg-accent/10" : "text-foreground/80 hover:text-foreground hover:bg-muted"}`,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "svg",
          {
            ...
            "aria-hidden": "true",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M16 .5C7.44.5.5 7.44.5 16c0 2.82.74 5.48 2.03 7.79L.5 31.5l7.97-2.03A15.45 15.45 0 0 0 16 31.5C24.56 31.5 31.5 24.56 31.5 16S24.56.5 16 .5zm0 28.1c-2.62 0-5.07-.72-7.17-1.97l-.51-.3-5.3 1.39 1.42-5.17-.34-.54A12.59 12.59 0 0 1 3.4 16C3.4 9.06 9.07 3.4 16 3.4 22.93 3.4 28.6 9.06 28.6 16S22.93 28.6 16 28.6zm6.9-9.4c-.38-.19-2.23-1.1-2.57-1.22-.35-.13-.6-.19-.86.19-.25.37-.98 1.22-1.2 1.47-.22.25-.44.28-.82.09-.38-.19-1.6-.59-3.04-1.88-1.12-1-1.88-2.24-2.1-2.62-.22-.38-.02-.58.16-.77.17-.17.38-.44.56-.66.19-.22.25-.38.38-.63.12-.25.06-.47-.03-.66-.09-.19-.86-2.07-1.18-2.83-.31-.74-.63-.64-.86-.65H9.9c-.22 0-.6.09-.91.44-.31.35-1.19 1.16-1.19 2.82 0 1.67 1.22 3.28 1.39 3.51.16.22 2.4 3.67 5.83 5.14.81.35 1.45.56 1.94.72.82.26 1.56.22 2.14.13.65-.1 2-.82 2.28-1.6.28-.78.28-1.46.19-1.6-.09-.13-.31-.22-.69-.41z" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hidden sm:inline", children: "Chat with Us" })
      ]
    }
  );
}
...
function AboutSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-20 bg-muted/30", "data-ocid": "about.section", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "container mx-auto px-4 sm:px-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: imgRef, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative rounded-2xl overflow-hidden shadow-elegant", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "img",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-6 left-6 bg-card/95 backdrop-blur-sm rounded-xl px-5 py-3 shadow-card", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-2xl font-semibold gradient-gold", children: "8+ Years" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground mt-0.5", children: "Of trusted beauty excellence" })
      ] })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: textRef, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body tracking-[0.25em] uppercase text-accent mb-3", children: "About Us" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground mb-5 leading-tight", children: [
        "Where Beauty Meets",
        /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold", children: "Artistry & Care" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground leading-relaxed mb-5", children: "Beauty N Joy was founded on a simple belief: every woman deserves to feel her most radiant self. Our salon blends cutting-edge beauty science with timeless artistry, creating a sanctuary where you can relax, refresh, and emerge transformed." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-muted-foreground leading-relaxed mb-8", children: "From bridal makeovers to everyday glam, our team of certified artists and therapists tailor every treatment to your unique beauty needs — using only the finest international products." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: highlights.map((h) => {
        const Icon2 = h.icon;
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-9 h-9 rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-5 h-5 text-primary" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-semibold text-foreground", children: h.title }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground font-body leading-relaxed mt-0.5", children: h.desc })
              ] })
            ]
          },
          h.title
...
function ContactSection() {
  const headerRef = useScrollReveal({ direction: "up" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body tracking-[0.25em] uppercase text-accent mb-3", children: "Reach Out" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground", children: [
            "Get In ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold", children: "Touch" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-body text-muted-foreground max-w-xl mx-auto", children: "Have a question or ready to book? We'd love to hear from you." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: infoRef, className: "flex flex-col gap-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl overflow-hidden shadow-elegant h-64", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "iframe",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-3", children: INFO.map(({ icon: Icon2, label, value }) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                className: "flex items-start gap-3 p-4 rounded-xl bg-card shadow-card border border-border",
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0 w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 text-primary" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body text-muted-foreground", children: label }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body font-medium text-foreground break-words", children: value })
                  ] })
                ]
              },
              label
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: formRef, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "form",
            {
              ...
              children: [
                ...
                sent && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: "✓ Opening WhatsApp — we'll be in touch soon!"
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Button,
...
const services = [
  {
    id: "bridal-makeup",
    title: "Bridal Makeup",
    description: "Flawless, long-lasting bridal looks crafted to make you radiant on your most special day.",
  ...
  },
  {
    id: "hair-styling",
    title: "Hair Styling",
    description: "Expert cuts, styling, colouring and treatments for every hair type and occasion.",
    price: "Starting ₹799",
  ...
  },
  {
    ...
    description: "Deeply nourishing facials using premium products for visibly glowing, healthy skin.",
    price: "Starting ₹999",
  ...
  },
  {
    id: "nail-art",
    title: "Nail Art",
    description: "Artistic, precision nail designs from classic French tips to elaborate festive nail art.",
    price: "Starting ₹399",
  ...
  },
  {
    id: "skin-care",
    title: "Skin Care",
    description: "Customised skin care rituals targeting pigmentation, acne, dryness and dullness.",
  ...
  },
  {
    id: "hair-spa",
    title: "Hair Spa",
    description: "Restorative spa treatments that strengthen, moisturise and add brilliant shine to hair.",
    price: "Starting ₹699",
  ...
  },
  {
    id: "party-makeup",
    title: "Party Makeup",
    description: "Glamorous event-ready makeup designed to photograph beautifully and last all night.",
  ...
  },
  {
    ...
    description: "Perfectly shaped brows and smooth skin with gentle, expert waxing and threading.",
    price: "Starting ₹199",
...
const testimonials = [
  {
    ...
    rating: 5,
    review: "Beauty N Joy made me look absolutely stunning on my wedding day. The bridal makeup lasted beautifully through the entire ceremony. Every guest complimented my look — I felt like a queen!"
  },
  {
    id: "t2",
    name: "Ananya Patel",
    ...
    rating: 5,
    review: "I have been coming here for over two years for facials and hair treatments. The results are consistently amazing and the staff is so warm and professional. This is truly a premium experience."
  },
  {
    id: "t3",
    name: "Rhea Kapoor",
    ...
    rating: 5,
    review: "The party glam makeup they did for my anniversary event was breathtaking. Everyone kept asking who did my makeup. The team here truly understands luxury beauty."
  }
];
const faqs = [
  {
    ...
    answer: "Absolutely! We specialise in bridal makeup for all skin tones and wedding styles. Our bridal packages include airbrush makeup, hairstyling, mehndi, and pre-bridal skin prep sessions. We also offer trial sessions before the big day."
  },
  {
    id: "faq2",
    question: "How can I book an appointment?",
    answer: "You can book via WhatsApp on +91 6388989935, call us directly, or use the contact form on this page. We recommend booking at least 3–5 days in advance for regular services and 1–2 months ahead for bridal bookings."
  },
  {
    id: "faq3",
    question: "Which products do you use?",
    answer: "We exclusively use premium international and Indian brands including MAC, Kryolan, Charlotte Tilbury, Forest Essentials, and Kérastase. All products are dermatologist-tested, cruelty-free, and safe for sensitive skin."
  },
  {
    id: "faq4",
    question: "Do you provide home service?",
    answer: "Yes, we offer home beauty services across the city for bridal and party makeup. A travel surcharge applies based on distance. Please contact us in advance to schedule a home visit."
  },
  {
    id: "faq5",
    question: "What are your working hours?",
    answer: "We are open Monday to Saturday from 10:00 AM to 8:00 PM, and Sundays from 11:00 AM to 6:00 PM. On bridal booking days, we may open earlier — please arrange with us in advance."
  }
];
function FaqSection() {
  const headerRef = useScrollReveal({ direction: "up" });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "faq", className: "py-20 bg-background", "data-ocid": "faq.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6 max-w-3xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "text-center mb-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body tracking-[0.25em] uppercase text-accent mb-3", children: "Got Questions?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground", children: [
        "Frequently ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold", children: "Asked Questions" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: listRef, "data-ocid": "faq.list", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Accordion, { type: "single", collapsible: true, className: "space-y-3", children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      AccordionItem,
      {
        value: faq.id,
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionTrigger, { className: "font-body text-sm sm:text-base font-medium text-foreground py-5 hover:no-underline", children: faq.question }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(AccordionContent, { className: "font-body text-sm text-muted-foreground leading-relaxed pb-5", children: faq.answer })
        ]
      },
      faq.id
    )) }) })
...
function GallerySection() {
  ...
  const lightboxPrev = () => setLightbox(
    (lb) => lb ? { index: (lb.index - 1 + gallery.length) % gallery.length } : null
  );
  const lightboxNext = () => setLightbox(
    (lb) => lb ? { index: (lb.index + 1) % gallery.length } : null
  );
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "text-center mb-12", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body tracking-[0.25em] uppercase text-accent mb-3", children: "Our Work" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground", children: [
              "Beauty ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold", children: "Gallery" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-body text-muted-foreground max-w-xl mx-auto", children: "A glimpse into the transformations and artistry that happen inside our salon every day." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: gallery.map((img, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-foreground/0 group-hover:bg-foreground/40 transition-smooth flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ZoomIn, { className: "w-7 h-7 text-white opacity-0 group-hover:opacity-100 transition-smooth" }) })
                  ]
                },
                img.id
              ))
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/generated/hero-beauty.dim_1400x900.jpg')"
            },
            "aria-hidden": "true"
          }
        ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative container mx-auto px-4 sm:px-6 py-32 max-w-3xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body tracking-[0.3em] uppercase text-primary-foreground/70 mb-4", children: "Luxury Beauty Parlour" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { ref: headRef, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-semibold text-white leading-[1.1] mb-6", children: [
            "Enhance Your ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold", children: "Natural" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "Beauty"
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Professional Beauty & Makeup Services for every occasion. From everyday elegance to bridal radiance — we celebrate you."
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: ctaRef, className: "flex flex-wrap gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                asChild: true,
...
function PricingCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    ...
    {
      ref,
      className: `relative rounded-2xl p-8 border flex flex-col gap-6 transition-smooth hover-lift ${plan.highlight ? "bg-card border-accent shadow-elegant scale-[1.02]" : "bg-card border-border shadow-card"}`,
      "data-ocid": `pricing.plan.${index2 + 1}`,
      children: [
        plan.badge && /* @__PURE__ */ jsxRuntimeExports.jsxs(Badge, { className: "absolute -top-3 left-1/2 -translate-x-1/2 bg-accent text-accent-foreground font-body text-xs px-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-3 h-3 mr-1" }),
          plan.badge
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs tracking-widest uppercase text-accent mb-2", children: plan.name }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display text-4xl font-semibold gradient-gold", children: plan.price }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground text-sm font-body mb-1", children: "/session" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm font-body text-muted-foreground", children: plan.description })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3 flex-1", children: plan.features.map((f) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "li",
          {
            className: "flex items-center gap-2.5 text-sm font-body text-foreground",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-4 h-4 flex-shrink-0 text-accent" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          {
            asChild: true,
            className: `w-full rounded-full font-body font-medium transition-smooth ${plan.highlight ? "bg-accent text-accent-foreground hover:opacity-90" : "bg-primary/10 text-primary hover:bg-primary hover:text-primary-foreground"}`,
            "data-ocid": `pricing.book.button.${index2 + 1}`,
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
...
function PricingSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "text-center mb-14", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body tracking-[0.25em] uppercase text-accent mb-3", children: "Transparent Pricing" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground", children: [
            "Beauty ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold", children: "Packages" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-body text-muted-foreground max-w-xl mx-auto", children: "All-inclusive packages with premium products and expert artistry — no hidden costs, just gorgeous results." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8 items-start", children: pricingPlans.map((plan, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(PricingCard, { plan, index: i }, plan.id)) })
      ] })
    }
  );
}
...
function ServiceCard({
  ...
  const Icon2 = iconMap[service.icon] ?? Sparkles;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-48 overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-3 left-3 w-9 h-9 rounded-full bg-card/90 backdrop-blur-sm flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "w-4 h-4 text-accent" }) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display text-lg font-semibold text-foreground mb-1", children: service.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-body text-muted-foreground leading-relaxed mb-4", children: service.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-sm font-semibold text-accent", children: service.price }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "a",
              {
                ...
                "data-ocid": `services.view_details.button.${index2 + 1}`,
...
function ServicesSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body tracking-[0.25em] uppercase text-accent mb-3", children: "What We Offer" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground", children: [
            "Our Premium ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold", children: "Services" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 font-body text-muted-foreground max-w-xl mx-auto", children: "From transformative bridal looks to everyday elegance, discover our full suite of luxury beauty treatments." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6", children: services.map((service, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(ServiceCard, { service, index: i }, service.id)) })
      ] })
    }
  );
}
function TestimonialsSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "section",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 sm:px-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { ref: headerRef, className: "text-center mb-12", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-body tracking-[0.25em] uppercase text-accent mb-3", children: "Happy Clients" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "font-display text-3xl sm:text-4xl font-semibold text-foreground", children: [
            "What Our Clients ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "gradient-gold", children: "Say" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: visibleIndices.map((idx, pos) => {
                ...
                return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-foreground/80 leading-relaxed mb-6 italic", children: [
                        "“",
                        t.review,
                        "”"
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-semibold text-foreground truncate", children: t.name }),
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground", children: t.role })
                        ] })
                      ] })
                    ]
                  },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center gap-4 mt-8", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2", children: testimonials.map((t, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                className: `w-2 h-2 rounded-full transition-smooth ${i === current ? "bg-accent scale-125" : "bg-border hover:bg-muted-foreground"}`,
